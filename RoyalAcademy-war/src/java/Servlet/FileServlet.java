 ...
 */
@WebServlet(urlPatterns = {"/faces/image/*", "/face/protected/image/*"})
public class FileServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        this.filePath = "/var/royalacademy/uploaded/images";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        File file = new File(filePath, URLDecoder.decode(requestFile, "UTF-8"));
        ...
        if (contentType == null || !contentType.equalsIgnoreCase("application/x-rar-compressed")) {
